...
{
	public class Coupled7and9eqsModelex8
    {
        public Eq78ModelProviderForStaggeredSolutionex8 Eq78ModelProvider { get; set; }
        public Eq9ModelProviderForStaggeredSolutionex8 Eq9ModelProvider { get; set; }
        ...
        public Coupled7and9eqsModelex8(Eq78ModelProviderForStaggeredSolutionex8 eq78ModelProvider,
                                     Eq9ModelProviderForStaggeredSolutionex8 eq9ModelProvider, ComsolMeshReader comsolReader,
