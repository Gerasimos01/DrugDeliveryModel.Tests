...
{
	public class Coupled7and9eqsModelex32
    {
        public Eq78ModelProviderForStaggeredSolutionex32 Eq78ModelProvider { get; set; }
        public Eq9ModelProviderForStaggeredSolutionex32 Eq9ModelProvider { get; set; }
        ...
        public Coupled7and9eqsModelex32(Eq78ModelProviderForStaggeredSolutionex32 eq78ModelProvider,
                                     Eq9ModelProviderForStaggeredSolutionex32 eq9ModelProvider, ComsolMeshReader comsolReader,
