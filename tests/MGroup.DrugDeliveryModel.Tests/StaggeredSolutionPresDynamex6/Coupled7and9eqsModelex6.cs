...
{
	public class Coupled7and9eqsModelex6
    {
        public Eq78ModelProviderForStaggeredSolutionex6 Eq78ModelProvider { get; set; }
        public Eq9ModelProviderForStaggeredSolutionex6 Eq9ModelProvider { get; set; }
        ...
        public Coupled7and9eqsModelex6(Eq78ModelProviderForStaggeredSolutionex6 eq78ModelProvider,
                                     Eq9ModelProviderForStaggeredSolutionex6 eq9ModelProvider, ComsolMeshReader comsolReader,
