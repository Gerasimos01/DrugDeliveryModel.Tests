...
{
    public class EquationCOxParametric
    {
        //---------------------------------------Equation Cox---------------------------------------
        ...
        /// </summary>
        private const double CoxIndependentSource = 0.2; // [mol/m3]

        private const double CoxBoundary = 0; // [mol/m3]
        ...
        private const double TotalTime = 0.0025;
        ...
        private readonly Func<double> independentLinearSource =() => PerOx * Sv * CoxIndependentSource;
        ...
        public static double SimpleProductionFuncWithoutConstantTerm(double cox)
        {
            return - PerOx * Sv * cox * (cox + 1) / (cox + 0.1);
        }

        //Non - Linear Derivative
        public static double SimpleProductionFuncWithoutConstantTermDDerivative(double Cox)
        {
            return -2* PerOx * Sv*Cox;
        }
        ...
        public void SolveEquationCOxLinearProduction(string fileName)
        {
            ...
            AddTopRightBackNodesBC(model, 0d, 0.1, 0, 0.1, 0, 0.1, CoxBoundary);
