...
namespace MGroup.DrugDeliveryModel.Tests.Integration
{
	public class Coupled7and9eqsSolutionex3
    {
        ...
        public Coupled7and9eqsSolutionex3()
		{
        ...
        public void MonophasicEquationModel(string fileName)
		{
           ...
           var eq78model = new Eq78ModelProviderForStaggeredSolutionex3(comsolReader, k_th, Lp, Sv, pv, LplSvl, pl, velocityDivergenceAtElementGaussPoints, 
            ...
            var eq9model = new Eq9ModelProviderForStaggeredSolutionex3(comsolReader, Sc, miNormal, kappaNormal, miTumor, kappaTumor, timeStep, totalTime, lambda, pressureTensorDivergenceAtElementGaussPoints,
            ...
            var equationModel = new Coupled7and9eqsModelex3(eq78model, eq9model, comsolReader, lambda,
