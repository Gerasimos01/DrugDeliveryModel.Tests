...
{
	public class Coupled7and9eqsModelex4
    {
        public Eq78ModelProviderForStaggeredSolutionex4 Eq78ModelProvider { get; set; }
        public Eq9ModelProviderForStaggeredSolutionex4 Eq9ModelProvider { get; set; }
        ...
        public Coupled7and9eqsModelex4(Eq78ModelProviderForStaggeredSolutionex4 eq78ModelProvider,
                                     Eq9ModelProviderForStaggeredSolutionex4 eq9ModelProvider, ComsolMeshReader comsolReader,
